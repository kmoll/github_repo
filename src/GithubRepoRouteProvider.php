...
/**
 * @file
 * Contains \Drupal\github_repo\GithubRepoRouteProvider.
 */
...
/**
 * Provides routes for Github repo entities.
 *
 */
class GithubRepoRouteProvider implements EntityRouteProviderInterface {
  /**
   * {@inheritdoc}
   */
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view github repo entities')
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      if ($bundle_entity_type_id = $entity_type->getBundleEntityType()) {
        $route
          ->setDefaults([
            '_controller' => 'Drupal\github_repo\Controller\GithubRepoAddController::addForm',
            '_title_callback' => 'Drupal\github_repo\Controller\GithubRepoAddController::getAddFormTitle',
          ])
...
//      $route
//        ->setDefaults([
//          '_controller' => 'Drupal\github_repo\Controller\GithubRepoAddController::add',
//          '_title' => "Add {$entity_type->getLabel()}",
//        ])
